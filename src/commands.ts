...
export enum CommandId {
    //device commands
    DEVICE_IP_COMMAND_PALETTE = "legato.cmd.device.availablecommands",
...
export class ContextualCommandPalette extends CommandRegister {
    ...
    public register() {
      ...
      this.commands.forEach((cmdDef: CommandDeclaration) => this.createCommand(cmdDef.id, () => cmdDef.callback()));
    }
